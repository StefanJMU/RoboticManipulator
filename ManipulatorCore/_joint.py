...
class Joint :
    ...
    def __init__(self,
        ...
        if joint_type == 'revolute' :
            self.joint_angle = Variable(tns(self.sanitize_angle(joint_angle),dtype=torch.float),requires_grad=True)
            ...
            self.joint_length = Variable(tns(self.sanitize_length(joint_length,'joint_length'),dtype=torch.float),requires_grad=True)
